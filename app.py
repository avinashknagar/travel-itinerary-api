...
async def generate_itinerary(preferences: PreferencesInput, background_tasks: BackgroundTasks):
    try:
        ...
        background_tasks.add_task(generate_itinerary_background, job_id, preferences_dict)
